...
export const config:Config = {
  api: {
    ...
    weatherBaseUrl: "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline",
  ...
  theme: {
    iconBaseUrl: "https://raw.githubusercontent.com/metno/weathericons/main/weather/svg/",
  },
};
